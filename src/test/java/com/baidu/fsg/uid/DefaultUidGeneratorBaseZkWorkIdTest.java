...
/**
 * Test for {@link com.baidu.fsg.uid.worker.WorkerIdAssignerBaseZookeeper}
 *
 * @author huaijin
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = { "classpath:uid/workid-zk-spring.xml" })
public class DefaultUidGeneratorBaseZkWorkIdTest {
    ...
    @Resource
    private WorkerIdAssigner workIdAssignerBaseZk;

    @Test
    public void testAssignWorkerId() {
        long firstWorkId = workIdAssignerBaseZk.assignWorkerId();
        long secondWorId = workIdAssignerBaseZk.assignWorkerId();
        Assert.assertEquals("Not equals", firstWorkId, secondWorId);
    }
